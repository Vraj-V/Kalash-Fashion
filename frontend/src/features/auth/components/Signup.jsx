...
import { ecommerceOutlookAnimation, shoppingBagAnimation, SaleFashionClothing } from '../../../assets'
    ...
    <Stack width={'100vw'} height={'100vh'} flexDirection={'row'} sx={{overflowY:"hidden"}}>

      {
        ...
        <Stack bgcolor={'black'} flex={1} justifyContent={'center'} >
          <Lottie animationData={SaleFashionClothing}/>
        </Stack>
        ...
        <Stack flex={1} justifyContent={'center'} alignItems={'center'}>
              ...
              <Stack flexDirection={'row'} justifyContent={'center'} alignItems={'center'}>
                  <Stack rowGap={'.4rem'}>
                    <Typography variant='h2' sx={{wordBreak:"break-word"}} fontWeight={600}>Kalash Fashion</Typography>
